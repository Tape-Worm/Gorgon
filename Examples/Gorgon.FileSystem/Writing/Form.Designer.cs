...
partial class Form
{
    ...
    private void InitializeComponent()
    {
        ...
        itemDeleteChanged = new ToolStripMenuItem();
        ...
        buttonSave.Size = new Size(55, 24);
        buttonSave.Text = "&Save";
        buttonSave.Click += ButtonSave_Click;
        // 
        // buttonReload
        // 
        buttonReload.DropDownItems.AddRange(new ToolStripItem[] { itemLoadChanged, itemLoadOriginal, toolStripSeparator2, itemDeleteChanged });
        buttonReload.Image = Properties.Resources.reload_filesystem_16x16;
        buttonReload.ImageTransparentColor = Color.Magenta;
        buttonReload.Name = "buttonReload";
        buttonReload.Size = new Size(76, 24);
        buttonReload.Text = "&Reload";
        // 
        // itemLoadChanged
        // 
        itemLoadChanged.Name = "itemLoadChanged";
        itemLoadChanged.Size = new Size(197, 22);
        ...
        itemLoadOriginal.Size = new Size(197, 22);
        ...
        toolStripLabel1.Size = new Size(528, 24);
        ...
        // panelWriteLocation
        // 
        panelWriteLocation.BackColor = SystemColors.Info;
        ...
        panelWriteLocation.ForeColor = SystemColors.InfoText;
        panelWriteLocation.Location = new Point(0, 22);
        panelWriteLocation.Margin = new Padding(4, 3, 4, 3);
        panelWriteLocation.Name = "panelWriteLocation";
        panelWriteLocation.Size = new Size(956, 22);
        panelWriteLocation.TabIndex = 2;
        // 
        // labelWriteLocation
        // 
        labelWriteLocation.Dock = DockStyle.Fill;
        labelWriteLocation.Location = new Point(22, 0);
        labelWriteLocation.Name = "labelWriteLocation";
        labelWriteLocation.Size = new Size(934, 22);
        labelWriteLocation.TabIndex = 0;
        labelWriteLocation.Text = "File system";
        labelWriteLocation.TextAlign = ContentAlignment.MiddleLeft;
        // 
        // pictureBox1
        // 
        ...
        panel3.Location = new Point(2, 532);
        panel3.Margin = new Padding(4, 3, 4, 3);
        panel3.Name = "panel3";
        panel3.Size = new Size(956, 66);
        panel3.TabIndex = 3;
        // 
        // panelFileSystem
        // 
        panelFileSystem.BackColor = SystemColors.Info;
        ...
        panelFileSystem.ForeColor = SystemColors.InfoText;
        panelFileSystem.Location = new Point(0, 0);
        panelFileSystem.Margin = new Padding(4, 3, 4, 3);
        panelFileSystem.Name = "panelFileSystem";
        panelFileSystem.Size = new Size(956, 22);
        panelFileSystem.TabIndex = 5;
        // 
        // labelFileSystem
        // 
        labelFileSystem.Dock = DockStyle.Fill;
        labelFileSystem.Location = new Point(22, 0);
        labelFileSystem.Name = "labelFileSystem";
        labelFileSystem.Size = new Size(934, 22);
        labelFileSystem.TabIndex = 0;
        labelFileSystem.Text = "File system";
        labelFileSystem.TextAlign = ContentAlignment.MiddleLeft;
        // 
        // pictureBox3
        // 
        ...
        panel4.ForeColor = SystemColors.InfoText;
        panel4.Location = new Point(0, 44);
        panel4.Name = "panel4";
        panel4.Size = new Size(956, 22);
        panel4.TabIndex = 3;
        // 
        // labelInfo
        // 
        labelInfo.Dock = DockStyle.Fill;
        labelInfo.Location = new Point(22, 0);
        labelInfo.Name = "labelInfo";
        labelInfo.Size = new Size(934, 22);
        ...
        // itemDeleteChanged
        // 
        itemDeleteChanged.Name = "itemDeleteChanged";
        itemDeleteChanged.Size = new Size(197, 22);
        itemDeleteChanged.Text = "Delete changed version";
        itemDeleteChanged.Click += ItemDeleteChanged_Click;
        // 
        // Form
        // 
    ...
    private ToolStripMenuItem itemDeleteChanged;
}