...
Imperdiet sit urna curabitur varius tortor. Penatibus per pretium integer facilisi ac. Vitae libero curabitur felis porta curabitur adipiscing natoque suscipit. Sit leo sed phasellus consectetur laoreet potenti.Nunc commodo senectus commodo imperdiet nunc dui.Elementum phasellus ut aptent euismod eros ipsum habitasse. Feugiat senectus eget molestie justo mollis morbi sit. Litora aptent dolor nulla ultrices est ac enim vivamus nibh. Dictum porttitor sed cubilia magna, velit rhoncus viverra molestie. Aptent vitae interdum ultrices; sit consequat fusce.";
    ...
    private void ButtonInformation_Click(object sender, RoutedEventArgs e) => GorgonDialogs.InformationAsync(this, "This is an information dialog. It is used to convey information to the user of the application.\n\nClick OK to return." + Lorem);
    ...
    /// <param name="sender">The sender of the event.</param>
    /// <param name="e">The event parameters.</param>
    private void ButtonWarning_Click(object sender, RoutedEventArgs e) => GorgonDialogs.WarningAsync(this, "This is a warning dialog. It is used to inform the user that an operation may have run into trouble.\n\nClick OK to return." + Lorem);
    ...
    /// <param name="sender">The sender of the event.</param>
    /// <param name="e">The event parameters.</param>
    private void ButtonWarningDetailed_Click(object sender, RoutedEventArgs e) => GorgonDialogs.WarningAsync(this, "This is a warning dialog. It is used to inform the user that an operation may have run into trouble.\n\nIt contains a detail button for more information about the warning, click it to show the detail panel.\n\nClick OK to return.", details: Lorem);
    ...
    /// <param name="sender">The sender of the event.</param>
    /// <param name="e">The event parameters.</param>
    private void ButtonError_Click(object sender, RoutedEventArgs e) => GorgonDialogs.ErrorAsync(this, "This is an error dialog. It is used to inform the user that something has gone wrong.\n\nClick OK to return." + Lorem);
    ...
    private void ButtonErrorDetails_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            GorgonDialogs.ErrorAsync(this, ex, "This is an error that was triggered by an Exception.\n\nClick the Details button to show information about the Exception.\n\nClick OK to return.");
        }
    }
    ...
    {
        if (await GorgonDialogs.ConfirmAsync(this, "This is a confirmation dialog. It is used to query the user about a decision that needs to be made.\n\nClick either Yes or No to return." + Lorem) == ConfirmationResult.Yes)
        {
            await GorgonDialogs.InformationAsync(this, "You clicked Yes.\n\nClick OK to return.");
        }
        else
        {
            await GorgonDialogs.InformationAsync(this, "You clicked No.\n\nClick OK to return.");
        }
    }
    ...
    /// <param name="sender">The sender of the event.</param>
    /// <param name="e">The event parameters.</param>
    private async void ButtonConfirmCancel_Click(object sender, RoutedEventArgs e)
    {
        ConfirmationResult result = await GorgonDialogs.ConfirmAsync(this, "This is a confirmation dialog. It is used to query the user about a decision that needs to be made.\n\nClick either Yes, No or Cancel to return.",
            allowCancel: true);
        ...
        switch (result)
        {
            ...
            case ConfirmationResult.Cancel:
                await GorgonDialogs.InformationAsync(this, "You clicked Cancel.\n\nClick OK to return.");
                return;
        }
    ...
    /// <param name="sender">The sender of the event.</param>
    /// <param name="e">The event parameters.</param>
    private async void ButtonConfirmToAll_Click(object sender, RoutedEventArgs e)
    {
        ConfirmationResult result = await GorgonDialogs.ConfirmAsync(this, "This is a confirmation dialog. It is used to query the user about a decision that needs to be made.\n\nClick either Yes, No or Cancel to return.",
        ...
        {
            case ConfirmationResult.Yes:
                await GorgonDialogs.InformationAsync(this, $"You clicked Yes.{extraText}\n\nClick OK to return.");
                return;
            case ConfirmationResult.No:
                await GorgonDialogs.InformationAsync(this, $"You clicked No.{extraText}\n\nClick OK to return.");
                return;
            case ConfirmationResult.Cancel:
                await GorgonDialogs.InformationAsync(this, "You clicked Cancel.\n\nClick OK to return.");
                return;
