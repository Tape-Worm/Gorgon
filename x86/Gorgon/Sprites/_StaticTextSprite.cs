...
namespace GorgonLibrary.Graphics
{
		...
		: Renderable, IDisposable, IDeviceStateObject
	{
		...
		public void UpdateTextBuffer(StringBuilder text)
		{
			...
			_textSprite.UpdateTextBuffer(text);
			_initialized = false;
		}
		...
		public void Initialize()
		{
			...
			try
			{
				...
				imageSize = _textSprite.MeasureText(new StringBuilder(_textSprite.Text), _textSprite.Bounds.Width, _textSprite.WordWrap);
				...
				_textImage = RenderTarget.CreateRenderImage("@" + Name + ".TextSprite.RenderImage", (int)imageSize.Width, (int)imageSize.Height, ImageBufferFormats.BufferRGB888A8);
		...
		public StaticTextSprite(string name, string text, Vector2D position, Drawing.Color textColor)
		...
		/// <param name="text">Text for the sprite.</param>
		/// <param name="position">Initial position of the text.</param>
		public StaticTextSprite(string name, string text, Vector2D position)
		...
		/// <param name="name">Name of the text sprite.</param>
		/// <param name="text">Text for the sprite.</param>
		public StaticTextSprite(string name, string text)
		...
		/// <param name="text">Text for the sprite.</param>
		/// <param name="color">Color of the text.</param>
		public StaticTextSprite(string name, string text,Drawing.Color color)
		...
		/// </summary>
		/// <param name="name">Name of the text sprite.</param>
		public StaticTextSprite(string name)
		...
		/// <param name="positionY">Vertical position of the text.</param>
		/// <param name="textColor">Color of the</param>
		public StaticTextSprite(string name, string text, float positionX, float positionY, Drawing.Color textColor)
		...
		/// <param name="positionX">Horizontal position of the text.</param>
		/// <param name="positionY">Vertical position of the text.</param>		
		public StaticTextSprite(string name, string text, float positionX, float positionY)
