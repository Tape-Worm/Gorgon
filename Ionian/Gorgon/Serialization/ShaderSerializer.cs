...
namespace GorgonLibrary.Serialization
{
		...
		: Serializer
	{
		...
		public override void Serialize()
		{
			...
			_writer = new StreamWriterEx(SerializationStream, Encoding.UTF7, DontCloseStream);
		...
		public override void Deserialize()
		{
			...
			_reader = new StreamReaderEx(SerializationStream, Encoding.UTF7,DontCloseStream);
