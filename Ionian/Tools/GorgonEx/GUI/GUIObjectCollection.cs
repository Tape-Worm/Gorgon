...
namespace GorgonLibrary.Extras.GUI
{
		...
		: BaseCollection<GUIObject>
	{
		...
		/// <summary>
		/// Function to remove a GUI object by name.
		/// </summary>
		/// <param name="name">Name of the GUI object to remove.</param>
		...
		/// <summary>
		/// Function to remove a GUI object by index.
		/// </summary>
		/// <param name="index">Index of the GUI object to remove.</param>
