...
// This code was found on the Code Project (http://www.codeproject.com/useritems/DockExtender.asp).
...
namespace ControlExtenders
{
    ...
    public interface IFloaty
    {
		...
		/// <summary>
		/// MW - 070531 - Add this event to notify us when we click the close button of an undocked window.
		/// </summary>
    ...
    internal sealed class Floaty : Form, IFloaty
    {
		...
		/// <summary>
		/// Property to set or return whether the dock window is visible or not.
		/// </summary>
        ...
        {
			CancelEventArgs args = new CancelEventArgs(false);		// Fire a close event.
        ...
        public new void Show()
        {
			...
			// MW - 070531 - Make this turn on the splitter, I suspect this was forgotten about.
			if ((_dockState.Splitter != null) && (!_isFloating))
				_dockState.Splitter.Visible = true;
        ...
        public new void Hide()
        {
			...
			// MW - 070531 - Make this turn off the splitter, I suspect this was forgotten about.
			if (_dockState.Splitter != null)
				_dockState.Splitter.Visible = false;
        ...
        private void MakeFloatable(DockState dockState, int offsetx, int offsety)
        {
            ...
            SendMessage(_dockState.Handle.Handle, WM_LBUTTONUP, IntPtr.Zero, IntPtr.Zero);
            ps.X -= offsetx;
            ps.Y -= offsety;
            ...
            SendMessage(this.Handle, WM_SYSCOMMAND, new IntPtr(SC_MOVE | 0x02), IntPtr.Zero);
        }
		...
		/// <summary>
		/// Event fired when the undocked window closes.
		/// </summary>
		public event CancelEventHandler WindowClosing = null;
        #endregion
    }
