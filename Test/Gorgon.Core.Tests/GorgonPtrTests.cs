...
public class GorgonPtrTests
{
    ...
    public unsafe void ConstructorNullPointerThrowsNullReferenceException()
    {
        ...
        Assert.ThrowsExactly<NullReferenceException>(() => new GorgonPtr<int>(nullPtr, 1), "Expected NullReferenceException for null pointer.");
        Assert.ThrowsExactly<NullReferenceException>(() => new GorgonPtr<int>((nint)null, 1), "Expected NullReferenceException for null nint.");
        Assert.ThrowsExactly<NullReferenceException>(() => new GorgonPtr<int>((nuint)null, 1), "Expected NullReferenceException for null nuint.");
    }
    ...
    public unsafe void ConstructorNegativeCountThrowsArgumentException()
    {
        ...
        Assert.ThrowsExactly<ArgumentException>(() => new GorgonPtr<int>(dummyPtr, -1), "Expected ArgumentException for negative count with pointer constructor.");
        Assert.ThrowsExactly<ArgumentException>(() => new GorgonPtr<int>(dummyNint, -1), "Expected ArgumentException for negative count with nint constructor.");
        Assert.ThrowsExactly<ArgumentException>(() => new GorgonPtr<int>(dummyNuint, -1), "Expected ArgumentException for negative count with nuint constructor.");
    }
    ...
    public unsafe void ConstructorZeroCountThrowsArgumentException()
    {
        ...
        Assert.ThrowsExactly<ArgumentException>(() => new GorgonPtr<int>(dummyPtr, 0), "Expected ArgumentException for zero count with pointer constructor.");
        Assert.ThrowsExactly<ArgumentException>(() => new GorgonPtr<int>(dummyNint, 0), "Expected ArgumentException for zero count with nint constructor.");
        Assert.ThrowsExactly<ArgumentException>(() => new GorgonPtr<int>(dummyNuint, 0), "Expected ArgumentException for zero count with nuint constructor.");
    }
...
#pragma warning restore IDE0054 // Use '--' operator
    ...
    public void AsRefMethodThrowsExceptionWhenPointerIsNull()
    {
        ...
        Assert.ThrowsExactly<NullReferenceException>(() => gorgonPtrInt.AsRef<byte>());
    }
    ...
    public unsafe void AsRefMethodThrowsExceptionWhenOffsetIsOutOfRange()
    {
        ...
        Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => gorgonPtrInt.AsRef<byte>(sizeof(int)));
    }
    ...
    public unsafe void AsRefMethodThrowsExceptionWhenOffsetIsLessThanZero()
    {
        ...
        Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => gorgonPtrInt.AsRef<byte>(-1));
    }
    ...
    public void ToMethodThrowsExceptionWhenPointerIsNull()
    {
        ...
        Assert.ThrowsExactly<NullReferenceException>(() => GorgonPtr<int>.To<byte>(gorgonPtrInt));
    }
    ...
    public unsafe void ToMethodThrowsInvalidCastException()
    {
        ...
        Assert.ThrowsExactly<InvalidCastException>(() => GorgonPtr<byte>.To<int>(gorgonPtrByte));
    }
