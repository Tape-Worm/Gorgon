...
public class GorgonNamedObjectTests
{
    ...
    public void LinqExtensions()
    {
        ...
        Assert.AreNotEqual(-1, objects.IndexOfName(item3.Name));
        Assert.AreEqual(1, objects.IndexOfName(item2.Name, StringComparer.Ordinal));
        Assert.AreEqual(-1, objects.IndexOfName(Guid.Empty.ToString(), StringComparer.Ordinal));
        ...
        Assert.AreNotEqual(-1, enumObjects.IndexOfName(item3.Name));
        Assert.AreEqual(1, enumObjects.IndexOfName(item2.Name, StringComparer.Ordinal));
        Assert.AreEqual(-1, enumObjects.IndexOfName(Guid.Empty.ToString(), StringComparer.Ordinal));
