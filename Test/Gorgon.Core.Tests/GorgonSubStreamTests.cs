...
public class GorgonSubStreamTests
{
    ...
    public void ReadWhenOffsetIsNegativeThrowsArgumentOutOfRangeException()
    {
        ...
        Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => subStream.Read(buffer, -1, 0));
    }
    ...
    public void ReadWhenCountIsNegativeThrowsArgumentOutOfRangeException()
    {
        ...
        byte[] buffer = new byte[10];
        Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => subStream.Read(buffer, 0, -1));
    }
    ...
    public void ReadWhenOffsetAndCountAreLargerThanBufferLengthThrowsArgumentException()
    {
        ...
        byte[] buffer = new byte[10];
        Assert.ThrowsExactly<ArgumentException>(() => subStream.Read(buffer, 5, 6));
    }
    ...
    {
        using MemoryStream parentStream = new(new byte[100]);
        Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => new GorgonSubStream(parentStream, -1));
    }
    ...
    {
        using MemoryStream parentStream = new(new byte[100]);
        Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => new GorgonSubStream(parentStream, 0, -1));
    }
    ...
    {
        using MemoryStream parentStream = new(new byte[100]);
        Assert.ThrowsExactly<EndOfStreamException>(() => new GorgonSubStream(parentStream, 200));
    }
    ...
    public void ConstructorShouldThrowExceptionWhenParentStreamCannotSeek()
    {
        ...
        Assert.ThrowsExactly<ArgumentException>(() => new GorgonSubStream(dummy));
    }
    ...
    public void ConstructorShouldThrowExceptionWhenParentStreamIsReadOnlyAndAllowWriteIsTrue()
    {
        ...
        Assert.ThrowsExactly<IOException>(() => new GorgonSubStream(parentStream, 0, null, true));
    }
    ...
    {
        using MemoryStream parentStream = new(new byte[100]);
        Assert.ThrowsExactly<EndOfStreamException>(() => new GorgonSubStream(parentStream, 50, 60));
    }
