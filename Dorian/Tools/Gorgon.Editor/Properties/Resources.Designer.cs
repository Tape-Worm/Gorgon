...
namespace GorgonLibrary.Editor.Properties {
    ...
    internal class Resources {
        ...
        /// </summary>
        internal static string GOREDIT_FILE_EXTENSION_EXISTS {
            get {
                return ResourceManager.GetString("GOREDIT_FILE_EXTENSION_EXISTS", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Writer plug-in file extension: .{0} - {1}.
        /// </summary>
        internal static string GOREDIT_FILE_EXTENSION_TOSTR {
            get {
                return ResourceManager.GetString("GOREDIT_FILE_EXTENSION_TOSTR", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string GOREDIT_IMPORT_DLG_TITLE {
            get {
                return ResourceManager.GetString("GOREDIT_IMPORT_DLG_TITLE", resourceCulture);
            }
        }
