...
namespace GorgonLibrary.Graphics.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Vertex, Index and Constant buffers cannot have a usage of [Staging]..
        /// </summary>
        internal static string GORGFX_BUFFER_NO_STAGING_BUFFER_TYPE {
            get {
                return ResourceManager.GetString("GORGFX_BUFFER_NO_STAGING_BUFFER_TYPE", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Buffers that allow indirect arguments, shader views, unordered access views, raw views and render target views cannot have a usage of [Staging]..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to A buffer that allows stream output must not have a usage of [Dynamic] or [Staging]..
        /// </summary>
        internal static string GORGFX_BUFFER_OUTPUT_NOT_DYNAMIC_OR_STAGING {
            get {
                return ResourceManager.GetString("GORGFX_BUFFER_OUTPUT_NOT_DYNAMIC_OR_STAGING", resourceCulture);
            }
        }
