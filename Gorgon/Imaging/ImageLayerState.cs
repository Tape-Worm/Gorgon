...
namespace GorgonLibrary.Internal
{
	...
	public class ImageLayerStates
	{
		...
		private void SetAlphaOperation(ImageOperations value)
		{
			...
			if (DeviceReady)
				Device.TextureState[_imageLayerIndex].AlphaOperation = Converter.Convert(value);
		...
		private void SetAlphaOperationArgument0(ImageOperationArguments value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.TextureState[_imageLayerIndex].AlphaArgument0 = Converter.Convert(value);
		...
		private void SetAlphaOperationArgument1(ImageOperationArguments value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.TextureState[_imageLayerIndex].AlphaArgument1 = Converter.Convert(value);
		...
		private void SetAlphaOperationArgument2(ImageOperationArguments value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.TextureState[_imageLayerIndex].AlphaArgument2 = Converter.Convert(value);
		...
		private void SetColorOperation(ImageOperations value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.TextureState[_imageLayerIndex].ColorOperation = Converter.Convert(value);
		...
		private void SetColorOperationArgument0(ImageOperationArguments value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.TextureState[_imageLayerIndex].ColorArgument0 = Converter.Convert(value);
		...
		private void SetColorOperationArgument1(ImageOperationArguments value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.TextureState[_imageLayerIndex].ColorArgument1 = Converter.Convert(value);
		...
		private void SetColorOperationArgument2(ImageOperationArguments value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.TextureState[_imageLayerIndex].ColorArgument2 = Converter.Convert(value);
		...
		private void SetConstantColor(Color value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.TextureState[_imageLayerIndex].ConstantColor = value;
		...
		private void SetImageMagFilter(ImageFilters value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.SamplerState[_imageLayerIndex].MagFilter = Converter.Convert(value);
		...
		private void SetImageMinFilter(ImageFilters value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.SamplerState[_imageLayerIndex].MinFilter = Converter.Convert(value);
		...
		private void SetBorderColor(Color value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.SamplerState[_imageLayerIndex].BorderColor = value;
			_borderColor = value;
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetUAddressing(ImageAddressing value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.SamplerState[_imageLayerIndex].AddressU = Converter.Convert(value);
			_Uaddress = value;
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetVAddressing(ImageAddressing value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.SamplerState[_imageLayerIndex].AddressV = Converter.Convert(value);
			_Vaddress = value;
			DX.DirectXException.EnableExceptions();
		}
