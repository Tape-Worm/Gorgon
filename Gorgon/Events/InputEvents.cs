...
namespace GorgonLibrary.Input
{
	...
	{
		#region Variables.
		private MouseButton _button;			// Buttons that are pressed while the mouse is being moved.
		private MouseButton _shiftButtons;		// Other buttons being held down.
		...
		/// </summary>
		public MouseButton ShiftButtons
		{
			get
			{
		...
		public MouseInputEventArgs(MouseButton buttons, MouseButton shiftButtons, Vector2D position, int wheelPosition, Vector2D relativePosition, int wheelDelta, int clickCount)
		{
			_button = buttons;
		...
		: EventArgs
	{
		...
		public KeyboardInputEventArgs(KeyboardKeys key, KeyboardKeys modifierKey, Keyboard.KeyCharMap character, int scanData)
		{
			_key = key;
