...
namespace GorgonLibrary.Graphics.Shaders
{
	...
	{
		#region Variables.
		private D3D.EffectHandle _effectHandle;			// Handle to the technique.
		...
		public bool Valid
		{
			get
			{
				return _owner.D3DEffect.IsTechniqueValid(_effectHandle);
			}
		}
		#endregion
		...
		private void GetTechnique(int index)
		{
			...
			{
				throw new CannotRetrieveTechniquesException(_owner.Name, ex);
			}
		}
