...
namespace GorgonLibrary.Serialization
{
	...
	public class ShaderSerializer
		: Serializer<StreamReaderEx, StreamWriterEx>, ISerializer 
	{
		#region Methods.
		/// <summary>
		...
		public override void Serialize()
		{
			...
			_writer = new StreamWriterEx(_stream, Encoding.UTF7, DontCloseStream);
		...
		public override void Deserialize()
		{
			...
			_reader = new StreamReaderEx(_stream, Encoding.UTF7,DontCloseStream);
