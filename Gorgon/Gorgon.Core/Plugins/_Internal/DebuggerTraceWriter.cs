...
namespace System.Composition.Diagnostics
{
    ...
    {
        private static readonly string _sourceName = typeof(DebuggerTraceWriter).Assembly.GetName().Name;
        ...
        public override void WriteInformation(CompositionTraceId traceId, string format, params object[] arguments) => WriteEvent(TraceEventType.Information, traceId, format, arguments);

        public override void WriteWarning(CompositionTraceId traceId, string format, params object[] arguments) => WriteEvent(TraceEventType.Warning, traceId, format, arguments);

        public override void WriteError(CompositionTraceId traceId, string format, params object[] arguments) => WriteEvent(TraceEventType.Error, traceId, format, arguments);
