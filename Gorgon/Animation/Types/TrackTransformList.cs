...
{
	/// <summary>
	/// Object representing a list of transformation tracks.
	/// </summary>
	public class TrackTransformList
		: TrackList<TrackTransform>
	{
		#region Method.
		/// <summary>
		...
		public override TrackTransform Create(string name)
		{
			TrackTransform newTrack = null;       // New track.

			if (Contains(name))
				throw new DuplicateObjectException(name);

			newTrack = new TrackTransform(Owner, name);
		...
		internal TrackTransformList(Animation owner)
			: base(owner)
		{
		}
		#endregion
