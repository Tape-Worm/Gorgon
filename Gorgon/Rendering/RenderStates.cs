...
namespace GorgonLibrary.Internal
{
	...
	public class RenderStates
	{
		...
		private bool DeviceReady
		{
			get
			{
				if (Gorgon.Renderer != null)
					return Gorgon.Renderer.DeviceReady;
				else
					return false;
			}
		}
		...
		public float PointSize
		{
			...
			set
			{
				...
				if (value > Gorgon.Driver.MaximumPointSize)
					value = Gorgon.Driver.MaximumPointSize;
		...
		private void SetScissorTest(bool value)
		{
			...
			if (DeviceReady)
				Device.RenderState.ScissorTestEnable = value;
		...
		private void SetAlphaTestFunction(CompareFunctions value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.AlphaFunction = Converter.Convert(value);
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetAlphaTestValue(int value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.ReferenceAlpha = value;
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetAlphaTestEnabled(bool value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.AlphaTestEnable = value;
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetSourceAlphaOperation(AlphaBlendOperation value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.SourceBlend = Converter.Convert(value);
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetDestinationAlphaOperation(AlphaBlendOperation value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.DestinationBlend = Converter.Convert(value);
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetCullMode(CullingMode value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.CullMode = Converter.Convert(value);
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetVertexPointSize(float value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.PointSize = value;
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetDepthBufferEnabled(bool value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.ZBufferEnable = value;
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetShadingMode(ShadingMode value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.ShadeMode = Converter.Convert(value);
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetSpecularEnabled(bool value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.SpecularEnable = value;
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetWBufferEnabled(bool value)
		{
			...
			if ((Gorgon.Screen != null) && (Gorgon.Screen.UseDepthBuffer))
			{
				...
				if (DeviceReady)
					Device.RenderState.UseWBuffer = value;
			}
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetDepthBufferBias(float value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.DepthBias = value;
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetDepthBufferCompareFunction(CompareFunctions value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.ZBufferFunction = Converter.Convert(value);
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetDrawingMode(DrawingMode value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.FillMode = Converter.Convert(value);
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetDrawLastPixel(bool value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.LastPixel = value;
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetStencilReference(int value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.ReferenceStencil = value;
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetStencilPassOperation(StencilOperations value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.StencilPass = Converter.Convert(value);
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetStencilFailOperation(StencilOperations value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.StencilFail = Converter.Convert(value);
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetStencilZFailOperation(StencilOperations value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.StencilZBufferFail = Converter.Convert(value);
			DX.DirectXException.EnableExceptions();
		}
		...
		private void SetStencilCompare(CompareFunctions value)
		{
			DX.DirectXException.IgnoreExceptions();
			if (DeviceReady)
				Device.RenderState.StencilFunction = Converter.Convert(value);
			DX.DirectXException.EnableExceptions();
		}
		...
		public void CheckForWBuffer(DepthBufferFormats targetFormat)
		{
			...
			if (Gorgon.Driver.SupportWBuffer)
			{
				switch (targetFormat)
				{
