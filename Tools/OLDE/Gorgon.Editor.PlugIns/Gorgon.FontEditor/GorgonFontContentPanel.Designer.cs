...
namespace Gorgon.Editor.FontEditorPlugIn
{
    partial class GorgonFontContentPanel
    {
		...
		private Splitter splitContent;
		private Panel panel1;
        private Panel panelControls;
		internal GorgonSelectablePanel panelTextures;
        internal Panel panelText;
        private Panel panelToolbar;
		private ToolStrip stripFontDisplay;
        private ToolStripButton buttonPrevTexture;
        private ToolStripLabel labelTextureCount;
        private ToolStripButton buttonNextTexture;
		private ToolStripSeparator toolStripSeparator2;
        private ToolStripLabel labelSelectedGlyphInfo;
		private ToolStrip stripCommands;
        private ToolStripLabel labelHoverGlyphInfo;
		private ToolStripSeparator separatorGlyphInfo;
		private ToolStripDropDownButton menuTextColor;
		private ToolStripMenuItem itemSampleTextForeground;
		private ToolStripMenuItem itemSampleTextBackground;
		private ToolStripDropDownButton menuShadow;
		private ToolStripMenuItem itemPreviewShadowEnable;
		private ToolStripSeparator toolStripSeparator4;
		private ToolStripMenuItem itemShadowOpacity;
		private ToolStripMenuItem itemShadowOffset;
		private Panel panel2;
		private ToolStripSeparator toolStripSeparator5;
		private ToolStripLabel labelPreviewText;
		private ToolStripTextBox textPreviewText;
        ...
        private Panel panelGlyphEdit;
		private Panel panelGlyphClip;
		private NumericUpDown numericGlyphHeight;
		private NumericUpDown numericGlyphWidth;
		private NumericUpDown numericGlyphTop;
		private NumericUpDown numericGlyphLeft;
		private Label labelGlyphHeight;
		private Label labelGlyphWidth;
		private Label labelGlyphTop;
        private Label labelGlyphLeft;
		private Button buttonGlyphClipOK;
		private Button buttonGlyphClipCancel;
        private Panel panel5;
		private Panel panelInnerDisplay;
		...
		private Panel panelGlyphAdvance;
		private NumericUpDown numericGlyphAdvance;
		private NumericUpDown numericOffsetY;
		private NumericUpDown numericOffsetX;
		private Label labelGlyphAdvance;
		private Label labelGlyphOffsetTop;
		private Label labelGlyphOffsetLeft;
		private Button buttonResetGlyphOffset;
		private ToolTip tipButtons;
		private Button buttonResetGlyphAdvance;
        private Panel panelKerningPairs;
        private ComboBox comboSecondGlyph;
        private Button buttonKernCancel;
        private Button buttonKernOK;
        private NumericUpDown numericKerningOffset;
        private Label labelKerningOffset;
        private Label labelKerningSecondaryGlyph;
		private Panel panel4;
		private Panel panel3;
		private ToolStripButton buttonEditPreviewText;
		private ToolStrip stripGlyphs;
		private ToolStripButton buttonEditGlyph;
		private ToolStripSeparator sepGlyphSpacing;
		private ToolStripButton buttonGlyphKern;
		private ToolStripSplitButton buttonGlyphTools;
		private ToolStripMenuItem menuItemSetGlyph;
		private ToolStripSeparator toolStripSeparator8;
		private ToolStripMenuItem menuItemLoadGlyphImage;
		private ToolStripMenuItem menuItemRemoveGlyphImage;
		private ToolStripLabel labelFindGlyph;
		private ToolStripComboBox comboSearchGlyph;
		private ToolStripButton buttonSearchGlyph;
		private ToolStripSeparator sepGlyphEditing;
        internal Panel panelTextVertScroll;
        private VScrollBar scrollTextVertical;
        private ToolStripButton buttonGoHome;
        private ToolStripButton buttonRevert;
        private ToolStripSeparator toolStripSeparator6;
		private ToolStripSeparator toolStripSeparator7;
		private ToolStripLabel labelBlendMode;
		private ToolStripComboBox comboBlendMode;
