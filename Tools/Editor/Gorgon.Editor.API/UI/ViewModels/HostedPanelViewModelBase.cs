...
/// <remarks>
/// <para>
/// This view model is used when an operation requires more information from the user. Content plugins that have functions that have user defined parameters can use this to present those parameters 
/// within the same view as the content as pop up panel. 
/// </para>
/// <para>
/// To use a hosted panel the plugin must define the panel by inheriting from this view model, and passing in parameters that inherit from <see cref="HostedPanelViewModelParameters"/>. A view must be 
