...
" the editor because it lacks an appropriate plugin, then this button will be di" +
"sabled.";
        ...
        this.ButtonFileSystemRefresh.ToolTipValues.Description = "Refreshes the file system and reassociates content files with their plugins.";
